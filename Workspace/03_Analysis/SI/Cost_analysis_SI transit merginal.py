...
transit_cost['Time_Value_Matching_Social_ice_58'] = (
        ((transit_cost['TNC_total_fare'] + ice_cost['Externality'] - transit_cost['Transit_fare'] - 0)
         / (transit_cost['Transit_duration'] - transit_cost['TNC_duration_total'])) * 60)

transit_cost['Time_Value_Matching_Social_ev40_58'] = (
        ((transit_cost['TNC_total_fare'] + EV40_cost['Externality'] - transit_cost['Transit_fare'] - 0)
         / (transit_cost['Transit_duration'] - transit_cost['TNC_duration_total'])) * 60)

transit_cost['Time_Value_Matching_Social_ev60_58'] = (
        ((transit_cost['TNC_total_fare'] + EV60_cost['Externality'] - transit_cost['Transit_fare'] - 0)
         / (transit_cost['Transit_duration'] - transit_cost['TNC_duration_total'])) * 60)

#=======================
transit_cost['Time_Value_Matching_Social_ice_172'] = (
        ((transit_cost['TNC_total_fare'] + ice_cost['Externality'] + ice_cost['GHG_cost'] * (172/58 - 1)
          - transit_cost['Transit_fare'] - 0 - 0 * (172/58 - 1))
         / (transit_cost['Transit_duration'] - transit_cost['TNC_duration_total'])) * 60)

transit_cost['Time_Value_Matching_Social_ev40_172'] = (
        ((transit_cost['TNC_total_fare'] + ice_cost['Externality'] + EV40_cost['GHG_cost'] * (172/58 - 1)
          - transit_cost['Transit_fare'] - 0 - 0 * (172/58 - 1))
         / (transit_cost['Transit_duration'] - transit_cost['TNC_duration_total'])) * 60)

transit_cost['Time_Value_Matching_Social_ev60_172'] = (
        ((transit_cost['TNC_total_fare'] + ice_cost['Externality'] + EV60_cost['GHG_cost'] * (172/58 - 1)
          - transit_cost['Transit_fare'] - 0 - 0 * (172/58 - 1))
         / (transit_cost['Transit_duration'] - transit_cost['TNC_duration_total'])) * 60)
...
transit_cost['Time_Value_Matching_Social_ice_190'] = (
        ((transit_cost['TNC_total_fare'] + ice_cost['Externality'] + ice_cost['GHG_cost'] * (190/58 - 1)
          - transit_cost['Transit_fare'] - 0 - 0 * (190/58 - 1))
         / (transit_cost['Transit_duration'] - transit_cost['TNC_duration_total'])) * 60)
...
#####################################################################
# Save dfs into csv
#ice_cost.to_csv('C:/Users/miki/Documents/CSV data/Tripdata/Cost/dataframe_ice_cost.csv', index=False)
#.to_csv('C:/Users/miki/Documents/CSV data/Tripdata/Cost/dataframe_EV40_cost.csv', index=False)
#EV60_cost.to_csv('C:/Users/miki/Documents/CSV data/Tripdata/Cost/dataframe_EV60_cost.csv', index=False)
#transit_cost.to_csv('C:/Users/miki/Documents/CSV data/Tripdata/Cost/dataframe_transit_cost.csv', index=False)
...
columns_breakeventime = {
    'Breakeven': ['Time_Value_Matching'],
    'Breakeven vs ICE TNC 190': ['Time_Value_Matching_Social_ice_190'],
    'Breakeven vs EV (40kWh) TNC 190': ['Time_Value_Matching_Social_ev40_190'],
    'Breakeven vs EV (60kWh) TNC 190': ['Time_Value_Matching_Social_ev60_190']
}

for label, column in columns_breakeventime.items():
    q1 = transit_cost[column].quantile(0.25)
    q3 = transit_cost[column].quantile(0.75)
    median = transit_cost[column].median()

    formatted_value = f'{q1} - {q3} ({median})'
...
attributes = ['Time_Value_Matching', 'Time_Value_Matching_Social_ice_190', 'Time_Value_Matching_Social_ev40_190', 'Time_Value_Matching_Social_ev60_190']
...
for df_name, df in dfs.items():
    for attr in attributes:
        ...
        #p25 = df[attr].quantile(0.25)
        #p75 = df[attr].quantile(0.75)
