...
#Change to full occupancy
Bus.occupancy = 44
Subway.occupancy = 42 * 7
Train_diesel.occupancy = 148 * 6
Train_electric.occupancy = 148 * 6
...
#####################################################################
# Save dfs into csv
transit_cost.to_csv('dataframe_transit_cost_full.csv', index=False)

df_full = transit_cost

#################
#################
#################
#Half average capacity

#Change to full occupancy
Bus.occupancy = 4
Subway.occupancy = 4.5
Train_diesel.occupancy = 6
Train_electric.occupancy = 6
...
#####################################################################
# Save dfs into csv
transit_cost.to_csv('dataframe_transit_cost_empty.csv', index=False)

df_empty = transit_cost

############
#####################################################################
dfs = {
    'With full occupancy': df_full,
    'With half average occupancy': df_empty
}
